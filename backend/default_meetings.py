...
# Define the list of default meetings with combinations of Participants
default_meetings = [
    {
        "id": "MEET_AGB_001",
        "participant_ids": ["EA_SECURITY_001", "EA_INTEGRATION_002", "EA_DATA_003", "EA_GENAI_004"],
    ...
    },
    {
        ...
        "participant_ids": ["CTO_005", "CIO_006", "CDO_007"],
    ...
    },
    {
        ...
        "participant_ids": ["EA_SECURITY_001", "EA_DATA_003", "CDO_007"],
    ...
    },
    {
        ...
        "participant_ids": ["EA_GENAI_004", "CTO_005", "EA_INTEGRATION_002"],
...
def add_default_meetings():
    ...
    for meeting in default_meetings:
        ...
        try:
            cursor.execute(
                """
                INSERT INTO meetings (id, participant_ids, meeting_context, topic, userId)
                VALUES (?, ?, ?, ?, ?)
                """,
                (meeting["id"], participant_ids_json, meeting["meeting_context"], meeting["topic"], meeting["userId"]),
            )
