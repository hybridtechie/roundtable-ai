						...
						<div className="grid gap-4">
							<div>
								...
								<Input
									...
									onChange={(e) =>
										setEditedParticipant((prev) => (prev ? { ...prev, name: e.target.value } : null))
									}
								/>
							</div>
							<div>
								...
								<Input
									...
									onChange={(e) =>
										setEditedParticipant((prev) => (prev ? { ...prev, role: e.target.value } : null))
									}
								/>
							</div>
							<div>
							...
							<div>
								...
								<Textarea
									...
									onChange={(e) =>
										setEditedParticipant((prev) => (prev ? { ...prev, role_overview: e.target.value } : null))
									}
								/>
							</div>
							<div>
							...
							<div>
								...
								<Textarea
									...
									onChange={(e) =>
										setEditedParticipant((prev) => (prev ? { ...prev, soft_skills: e.target.value } : null))
									}
								/>
							</div>
							<div>
